...
<div class="formbody">
  ...
  <?php if(!empty($results)){ 
      echo form_open(base_url('region/update'),'post');
      foreach ($results as $key => $value ) ?>
      <ul class="yun_bt">
      <li class="dq"><a href="<?php echo base_url('region') ?>">新建region</a></li>
      </ul>
      <ul class="forminfo">
    <li>
      <label>云平台名称</label>
  ...
  <?php }else{
  echo form_open(base_url('region/create'),'post')?>
  <ul class="yun_bt">
     <li><a href="<?php echo base_url('cloud') ?>">新建云平台</a></li>
     <li class="dq"><a href="<?php echo base_url('region') ?>">region</a></li>
