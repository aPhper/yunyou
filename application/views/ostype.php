...
<div class="formbody">
  ...
  <?php if(!empty($results)){ 
      echo form_open(base_url('ostype/update'),'post');
      foreach ($results as $key => $value ) ?>
  <ul class="yun_bt">
     <li class="dq"><a href="<?php echo base_url('ostype') ?>">新建Offering</a></li>
  </ul>
  <ul class="forminfo">
    <li>
      <label>云平台名称</label>
  ...
  <?php }else{    
    echo form_open(base_url('ostype/create'),'post')?>
  <ul class="yun_bt">
     ...
     <li class="dq"><a href="<?php echo base_url('ostype') ?>">Ostype系统</a></li>
