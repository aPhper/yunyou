...
<div class="formbody">
  ...
  <?php if(!empty($results)){ 
      echo form_open(base_url('zone/update'),'post');
      foreach ($results as $key => $value ) ?>
      <ul class="yun_bt">
      <li class="dq"><a href="<?php echo base_url('zone') ?>">新建zone</a></li>
      </ul>
    <ul class="forminfo">
    <li>
      <label>region名称</label>
          <input name="col_region_name" type="text" class="dfinput" readonly="true" value="<?php echo $col_region_name ?>"/>
          <input type="button" value="请选择Region" class="btn"  onclick="openwin('<?php echo base_url('region/list_page/2') ?>','云列表',900,600)"/>
          <input name="col_region_id" type="hidden" class="dfinput" value="<?php echo $value['col_region_id'] ?>"/>
          ...
          <i class="red"><?php echo form_error('col_region_name') ?></i>
    </li>
    <li>
      <label>zone名称</label>
  ...
  <?php }else{
  echo form_open(base_url('zone/create'),'post')?>
  <ul class="yun_bt">
     <li><a href="<?php echo base_url('cloud') ?>">新建云平台</a></li>
     <li><a href="<?php echo base_url('region') ?>">region</a></li>
     <li class="dq"><a href="<?php echo base_url('zone') ?>">zone</a></li>
  ...
  <ul class="forminfo">
    <li>
      <label>region名称</label>
          <input name="col_region_name" type="text" class="dfinput" readonly="true" value="<?php echo set_value('col_region_name') ?>"/>
          <input type="button" value="请选择Region" class="btn"  onclick="openwin('<?php echo base_url('region/list_page/2') ?>','云列表',800,600)"/>
          <input name="col_region_id" type="hidden" class="dfinput" value="<?php echo set_value('col_region_id') ?>"/>
          <i class="red"><?php echo form_error('col_region_name') ?></i>
    </li>
    <li>
      <label>zone名称</label>
